...
--
-- Host: localhost:3306
-- Generation Time: Jun 14, 2018 at 11:36 AM
...
INSERT INTO `users` (`id`, `email`, `password`, `username`, `status`, `verified`, `resettable`, `roles_mask`, `registered`, `last_login`, `force_logout`) VALUES
  ...
  (3, 'admin@admin.fr', '$2y$10$oSUnklW4ioA/8qeiKR.K4exp/ckfhegSN9zyPyhSrr0S7FM7eXZDW', 'admin', 0, 1, 1, 262145, 1528874700, 1528874700, 1),
